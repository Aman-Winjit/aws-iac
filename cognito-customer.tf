resource "aws_cognito_user_pool" "worth_customer" {
  name = var.customer_user_pool_name
...
resource "aws_cognito_user_pool_client" "worth_customer_client" {
  name = var.customer_client_name
  user_pool_id = aws_cognito_user_pool.worth_customer.id
...
resource "aws_cognito_user_pool_domain" "worth_customer_domain" {
