resource "aws_cognito_user_pool" "worth_admin" {
...
resource "aws_cognito_user_pool_client" "worth_admin_client" {
  name = var.admin_client_name
  user_pool_id = aws_cognito_user_pool.worth_admin.id
...
resource "aws_cognito_user_pool_domain" "worth_admin_domain" {
